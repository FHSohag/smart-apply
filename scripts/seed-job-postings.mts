...
const jobPostings: CreateJobPostingInput[] = [
    ...
    },
  {
    ...
    description:
      "Seeking a digital marketing executive to plan and run social media campaigns, manage content calendars, and analyze campaign performance across platforms for our client accounts.",
    hardSkills: ["Digital Marketing", "Social Media Marketing", "Content Strategy"],
  ...
  },
  {
    ...
    description:
      "Entry-level IT support role troubleshooting hardware/software issues, managing employee accounts, and maintaining office network infrastructure.",
    hardSkills: ["IT Support", "Troubleshooting", "Networking Basics"],
    tools: ["MS Office", "Windows Server"],
    softSkills: ["Problem-solving", "Patience"],
    languages: [],
    minExperienceYears: 0,
    employmentType: "full-time",
    locationRaw: "Dhaka, Bangladesh",
  ...
  },
  {
    ...
    description:
      "Looking for a motivated sales representative to manage client relationships, meet monthly sales targets, and identify new business opportunities in the FMCG sector.",
    hardSkills: ["Sales", "Client Relationship Management"],
    tools: ["MS Office"],
    softSkills: ["Communication", "Negotiation", "Client handling"],
    languages: ["Bengali"],
    minExperienceYears: 1,
    employmentType: "full-time",
    locationRaw: "Dhaka, Bangladesh",
  ...
  {
    title: "HR Assistant",
    company: "Corporate Solutions BD",
    description:
      "Support the HR team with recruitment coordination, employee onboarding, and maintaining personnel records. Great opportunity for a fresher interested in human resources.",
    hardSkills: ["Human Resources", "Recruitment"],
    tools: ["MS Office"],
    softSkills: ["Communication", "Organization", "Confidentiality"],
    languages: [],
    minExperienceYears: 0,
    employmentType: "full-time",
    locationRaw: "Dhaka, Bangladesh",
  ...
  },
  {
    ...
    company: "Grandeur Hotel & Suites",
    description:
      "Seeking a friendly, well-organized front desk officer to manage guest check-in/check-out, handle reservations, and ensure a welcoming guest experience.",
    hardSkills: ["Guest Relations", "Reservation Management"],
    tools: ["MS Office"],
